...
if __name__ == '__main__':
    ...
    ###* Calling Differential Evolution to find the best regions of the input space
    pbar = tqdm(total=de_max_iter, desc="Optimizing DE")
    ...
    de_result = sp.optimize.differential_evolution(
        lambda params: grad_based.loss(params, optimizer),
    ...
    print("total nb candidates: ", de_result.population.shape)
    ...
    grad_based.store_results(population_top_k, results_top_k, best_result, config, output_file)
