...
# ###* data for plot
# phi_vec = np.linspace(0.0, 0.3, 100)
# result_loss_stiff = []


# for phi in phi_vec:
#     loss_stiff = loss_stiff_subspace(np.array([phi]), optimizer, diff, config_dict)
#     result_loss_stiff.append(loss_stiff)


# with h5py.File("data_stiff.h5", "w") as f:
#     f.create_dataset("phi_vec", data=phi_vec)
#     f.create_dataset("result_loss_stiff", data=result_loss_stiff)
